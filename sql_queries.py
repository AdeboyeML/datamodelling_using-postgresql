...
songplay_table_create = ("""CREATE TABLE songplay(songplay_id serial PRIMARY KEY, start_time timestamp NOT NULL,
user_id int NOT NULL, level varchar, song_id varchar, artist_id varchar, session_id int NOT NULL, location varchar, user_agent text)""")
...
song_table_create = ("""CREATE TABLE song(song_id varchar PRIMARY KEY, title varchar NOT NULL, artist_id varchar NOT NULL, year int, duration float)""")

artist_table_create = ("""CREATE TABLE artist(artist_id varchar PRIMARY KEY, name varchar, location varchar, latitude float, longitude float)""")
...
song_select = ("""SELECT s.song_id songid, a.artist_id artistid FROM song s JOIN artist a ON s.artist_id = a.artist_id""")
